...
namespace ProjetoFinal
{
    class Program
    {
        ...
        static void creditos()
        {
            ...
            Console.WriteLine("de Informática (Nova Matriz)");
            Console.SetCursorPosition(4,6);
            Console.WriteLine("Ministrada pelos professores");
            Console.SetCursorPosition(4,7);
            Console.WriteLine("Diego Neri e Ermogenes Palácio");
            Console.SetCursorPosition(20,9);
            Console.WriteLine("Desenvolvido por Caio Rodrigo");
            Console.SetCursorPosition(20,10);
            Console.WriteLine("Github : www.github.com/kaiorod");
            Console.SetCursorPosition(20,11);
            Console.WriteLine("Email : caiorodrigo2775@gmail.com");
